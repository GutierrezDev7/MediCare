...
const initialLogs: MedicationLog[] = [
  { id: '1', medicationId: '1', scheduledTime: new Date(new Date().setHours(8, 0, 0, 0)), status: 'taken' },
  { id: '2', medicationId: '1', scheduledTime: new Date(new Date().setHours(16, 0, 0, 0)), status: 'pending' },
  { id: '3', medicationId: '2', scheduledTime: new Date(new Date().setHours(9, 0, 0, 0)), status: 'taken' },
  { id: '4', medicationId: '2', scheduledTime: new Date(new Date().setHours(21, 0, 0, 0)), status: 'pending' },
];

export default function AdminPage() {
  const [medications, setMedications] = useState<Medication[]>(mockMedications);
  const [logs, setLogs] = useState<MedicationLog[]>(initialLogs);
  ...
  return <Dashboard medications={medications} logs={logs} onMarkAsTaken={handleMarkAsTaken} />;
}
